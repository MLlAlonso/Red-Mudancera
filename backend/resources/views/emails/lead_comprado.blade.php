                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <img src="https://app.mudanzafacil.com.mx/logo/logo_B.png" alt="Mudanza Fácil"
                                style="height:60px;">
                        </td>
                    </tr>
                        ...
                        <td style="padding:24px;color:#4A5E71;">
                            ...
                            <div style="margin-top:20px;">
                                ...
                                <table width="100%" cellpadding="6" cellspacing="0" style="font-size:14px;">
                                    <tr>
                                        <td style="color:#6F7F8D;">Tipo de compra:</td>
                                        <td align="right">
                                            <strong style="color:#F1A43F;">
                                                {{ $tipoCompra ? 'Exclusivo' : 'Normal' }}
                                            </strong>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td style="color:#6F7F8D;">Créditos utilizados:</td>
                                        <td align="right">
                                            <strong>{{ $tokensPagados }}</strong>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="margin-top:28px;">
                                ...
                                <table width="100%" cellpadding="6" cellspacing="0" style="font-size:14px;">
                                    <tr>
                                        ...
                                        <td align="right"><strong>{{ $solicitud->inventario }}</strong></td>
                                    </tr>

                                    <tr>
                                        <td style="color:#6F7F8D;">Fecha estimada:</td>
                                        <td align="right">
                                            <strong>{{ $solicitud->fecha_recoleccion }}</strong>
                                        </td>
                                    </tr>
