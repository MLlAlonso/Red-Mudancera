                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="background:#09233E;padding:0 24px 24px 24px;text-align:center;">
                            <p style="margin:0;color:#ffffff;font-size:15px;line-height:1.5;">
                                Tu operación fue marcada como finalizada correctamente.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:24px;color:#4A5E71;">
                            ...
                            <p>
                                El siguiente servicio fue finalizado:
                            </p>

                            <div style=" margin-top:20px; padding:18px; border-radius:12px; background:#F4F7F6; border:1px solid #E8ECEB; ">
                                <table width="100%" cellpadding="6" cellspacing="0">
                                    ...
                                    @if ($servicio->ganancia)
                                        <tr>
                                            ...
                                            <td>
                                                $ {{ number_format($servicio->ganancia, 2) }}
                                            </td>
                                        </tr>
                                    @endif
                                </table>
                            ...
                            <p style="margin-top:24px; text-align: center;">
                                Gracias por seguir operando dentro de la red 🚚
                            </p>
                        </td>
                    </tr>
